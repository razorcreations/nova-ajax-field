...
window.Nova.booting(function (Vue) {
	Vue.component('IndexAjaxField', __webpack_require__(4));
	Vue.component('DetailAjaxField', __webpack_require__(7));
	Vue.component('FormAjaxField', __webpack_require__(10));
});
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vue_select__ = __webpack_require__(17);
...
/* harmony default export */ __webpack_exports__["default"] = ({
	...
	components: {
		VueSelect: __WEBPACK_IMPORTED_MODULE_1_vue_select___default.a
	},
	...
	methods: {
		...
		loadOptions: function loadOptions() {
			...
			window.Nova.request().get(this.field.url).then(function (_ref) {
				var data = _ref.data;
